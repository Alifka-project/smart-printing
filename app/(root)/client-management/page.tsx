  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-4 sm:p-6 lg:p-8">
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        {/* Filters */}
        <div className="client-management-filters grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <CardContent className="p-0">
            ...
            <div className="lg:hidden tablet-landscape:lg:hidden space-y-4 p-4">
              {loading ? (
                ...
                current.map((client) => (
                  <Card key={client.id} className="p-4 border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
                    <div className="space-y-4">
                      {/* Header with Client ID and Status */}
                      <div className="flex items-center justify-between">
                        <span className="font-mono text-sm font-medium text-slate-900 bg-blue-100 text-blue-800 px-3 py-1.5 rounded-lg">
                          {getClientDisplayId(client.id)}
                        </span>
                        <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                          client.status === "Active" 
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="space-y-1">
                          ...
                          <div className="font-medium text-slate-900 text-sm break-all">{client.email}</div>
                        </div>
                        <div className="space-y-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <div className="space-y-1">
                          <div className="text-xs font-medium text-slate-500 uppercase tracking-wide">Quotes</div>
                      ...
                      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between pt-4 border-t border-slate-100 gap-3">
                        <div className="flex flex-col sm:flex-row gap-2">
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() => onEdit(client)}
                            className="flex-1 sm:flex-none text-green-600 border-green-200 hover:bg-green-50"
                          >
