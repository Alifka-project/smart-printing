              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4 date-range-grid">
                <div className="flex flex-col">
                  ...
                  <Input
                    ...
                    className="border-slate-300 focus:border-blue-500 focus:ring-blue-500 rounded-lg h-9 sm:h-10 md:h-11 lg:h-12 text-xs sm:text-sm md:text-base lg:text-lg date-input px-2 sm:px-3 md:px-4 lg:px-5 w-full"
                  />
                </div>
                <div className="flex flex-col">
