...
const createEmptyProduct = (): Product => {
  ...
  return {
    ...
    useSameAsFlat: true,
    papers: [], // Empty papers array - no default paper
    finishing: [],
...
const createTrulyEmptyProduct = (): Product => {
  return {
    ...
    useSameAsFlat: true,
    papers: [], // Empty papers array for new quotes - no default paper
    finishing: [],
    finishingComments: '',
    colors: { front: "", back: "" },
    cupSizeOz: undefined,
...
const Step3ProductSpec: FC<Step3Props> = ({ formData, setFormData }) => {
  ...
  const removePaper = (pIdx: number, paperIdx: number) => {
    const product = formData.products[pIdx];
    // Allow removing papers even if it's the last one (for new quotes)
    updateProduct(pIdx, {
          ...
          <Card key={idx} className="border-0 shadow-lg">
            ...
            <CardContent className="space-y-6 sm:space-y-8">
              ...
              <div className="space-y-3 sm:space-y-4">
                ...
                {/* Show Add Paper Button - allow adding multiple papers */}
                {!paperDetailsDialogOpen && (
                ...
                {/* Paper Cards - show when there are papers */}
