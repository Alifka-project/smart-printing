          ...
          <CardContent className="p-0">
              ...
              <Table className="min-w-full lg:min-w-[900px]">
                <TableHeader className="bg-slate-50">
                  <TableRow className="border-slate-200">
                    <TableHead className="text-slate-700 font-semibold p-4 w-32">ID</TableHead>
                    <TableHead className="text-slate-700 font-semibold p-4 w-40">Sales Person</TableHead>
                    <TableHead className="text-slate-700 font-semibold p-4 w-48">Email</TableHead>
                    <TableHead className="text-slate-700 font-semibold p-4 w-36">Phone Number</TableHead>
                    <TableHead className="text-slate-700 font-semibold p-4 w-40">Department & Role</TableHead>
                    <TableHead className="text-slate-700 font-semibold p-4 w-28">Status</TableHead>
                    <TableHead className="text-center text-slate-700 font-semibold p-4 w-32">Actions</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {loading ? (
                    ...
                    filteredSalesPersons.map((person) => (
                      <TableRow key={person.id} className="hover:bg-slate-50 transition-colors duration-200 border-slate-100">
                        ...
                        <TableCell className="text-center p-4 w-32">
                          <div className="flex items-center justify-center space-x-2">
                            <Button
                              variant="ghost"
                              size="sm"
            ...
            <div className="lg:hidden tablet-landscape-hide space-y-4 p-4">
              {loading ? (
                ...
                filteredSalesPersons.map((person) => (
                  <Card key={person.id} className="p-4 border-slate-200 bg-white shadow-sm hover:shadow-md transition-shadow">
                    <div className="space-y-4">
                      ...
                      <div className="space-y-3">
                        <div className="flex items-center space-x-3">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="font-semibold text-slate-900 text-base">{person.name}</div>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="space-y-1">
                          ...
                          <div className="font-medium text-slate-900 text-sm break-all">{person.email}</div>
                        </div>
                        <div className="space-y-1">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        <div className="space-y-1">
                          <div className="text-xs font-medium text-slate-500 uppercase tracking-wide">Department</div>
                          <div className="font-medium text-slate-900">{person.department}</div>
                        </div>
                        <div className="space-y-1">
                          <div className="text-xs font-medium text-slate-500 uppercase tracking-wide">Hire Date</div>
